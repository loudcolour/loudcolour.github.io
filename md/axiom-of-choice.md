...
이런 난관으로부터 편리하게 벗어나기 위해 선택공리(axiom of choice)를 받아들여 사용할 수 있다.
...
ZF 상에서 선택공리는 독립된 명제이다. 따라서 선택공리를 포함하는 공리계로
ZFC를 도입하기도 한다.

ZF 상에서 선택공리와 동치인 것으로 알려진 명제는 다음이 있다.
...
- 의존선택공리 (axiom of dependent choice)
- 가산선택공리 (axiom of countable choice)
